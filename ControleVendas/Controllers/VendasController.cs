...
namespace ControleVendas.Controllers
{
    public class VendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VendaID,Produto,Descricao,Quantidade,ValorUnitario,ValorTotal,ClienteID,ColaboradorID")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("VendaID,Produto,Descricao,Quantidade,ValorUnitario,ValorTotal,ClienteID,ColaboradorID")] Venda venda)
        {
            if (id != venda.VendaID)
            {
                return NotFound();
