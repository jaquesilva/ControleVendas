...
namespace ControleVendas.Controllers
{
    public class ColaboradorsController : Controller
    {
        ...
        public ColaboradorsController(ControleVendasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ColaboradorID,NivelAcessoID,Nome,Cpf,Email,Senha,Telefone,Cargo")] Colaborador colaborador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ColaboradorID,NivelAcessoID,Nome,Cpf,Email,Senha,Telefone,Cargo")] Colaborador colaborador)
        {
